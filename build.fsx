...
#r @"packages/build/Fake.DotNet.AssemblyInfoFile/lib/net6.0/Fake.DotNet.AssemblyInfoFile.dll"
#r @"packages/build/Fake.Testing.Common/lib/net6.0/Fake.Testing.Common.dll"
#r @"packages/build/Fake.DotNet.Cli/lib/net6.0/Fake.DotNet.Cli.dll"
#r @"packages/build/Fake.DotNet.Testing.NUnit/lib/net6.0/Fake.DotNet.Testing.NUnit.dll"
#r @"packages/build/Fake.Core.ReleaseNotes/lib/net6.0/Fake.Core.ReleaseNotes.dll"
#r @"packages/build/Fake.Runtime/lib/net6.0/Fake.Runtime.dll"
...
#r @"packages/build/Fake.DotNet.Paket/lib/net6.0/Fake.DotNet.Paket.dll"
...
Target.create "AssemblyInfo" (fun _ ->
  !! "src/**/*.fsproj" |> Seq.iter genFSAssemblyInfo
  !! "src/**/*.csproj" |> Seq.iter genCSAssemblyInfo
)
...
Target.create "Build" (fun _ ->
    Fake.DotNet.MSBuild.build (fun p -> 
        { p with 
            Targets = ["Rebuild"] }
    ) solutionFile
)
...
//        Fake.Core.Trace.logfn "source linking %s" proj.OutputFilePdb
